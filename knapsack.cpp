...
// ΕΚΤΥΠΩΝΕΙ ΠΛΗΡΟΦΟΡΙΕΣ ΤΟΥ ΠΡΟΒΛΗΜΑΤΟΣ
...
// ΥΠΟΛΟΓΙΣΤΗΣ ΒΑΡΟΥΣ ΚΑΙ ΟΦΕΛΟΥΣ
            ...
            for (int k3 = 0; k3 < 4; k3++) {
                for (int k4 = 1; k4 <= 5; k4++) {
                    ...
                    if ((selection == 0) || (selection == 3)) {
                        ...
                        // ΥΠΟΛΟΓΙΣΜΟΣ ΒΑΡΟΥΣ ΚΑΙ ΟΦΕΛΟΥΣ (RESULT, FOUT)
...
int main(int argc, char* argv[]) {
    std::cout << "Please enter 1 for greedy aproach\n";
    std::cout << "Please enter 2 for brute forch solution\n";
    std::cout << "Please enter 3 for branch and bound solution\n";
    std::cout << "Please enter 4 for dynamic solution\n";
    std::cout << "Please enter 0 to export csv withs all algorithms\n";
